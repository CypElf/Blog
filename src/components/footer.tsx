...
export default function Footer({ className }: { className?: string }) {
    return (<footer className={`mt-14 bg-gray-2 flex justify-around items-center py-5 ${className}`}>
        <small className="text-xl">© 2021 - 2022 Elf</small>
        <div className="flex items-center flex-col lg:flex-row m-0 font-light text-lg">
            ...
            This blog is {'\u200B'}<a className="underline hover:text-green-1" href="https://github.com/CypElf/Blog">open source</a>
        </div>
